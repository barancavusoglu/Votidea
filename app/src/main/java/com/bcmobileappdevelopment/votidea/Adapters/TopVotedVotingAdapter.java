...
public class TopVotedVotingAdapter extends BaseQuickAdapter<GetTopVotingResponse.TopResultsBean,BaseViewHolder> {

    RequestOptions requestOptions,profilePicRequestOptions;
    public TopVotedVotingAdapter(int layout, List data){
        super(layout,data);
    }

    @Override
    protected void convert(BaseViewHolder viewHolder, GetTopVotingResponse.TopResultsBean item) {

...
public class HomeAdapter extends BaseQuickAdapter<GetMasterVotingRecordsResponse.MasterVotingListBean,BaseViewHolder> {

    RequestOptions requestOptions,profilePicRequestOptions;
    public HomeAdapter(int layout, List data){
        super(layout,data);
    }

    @Override
    protected void convert(BaseViewHolder viewHolder, GetMasterVotingRecordsResponse.MasterVotingListBean item) {

...
public class GetMasterVotingRecordsResponse {


    private boolean isSuccess;
    private String message;
    private List<MasterVotingListBean> masterVotingList;
    ...
    public List<MasterVotingListBean> getMasterVotingList() {
        return masterVotingList;
    }

    public void setMasterVotingList(List<MasterVotingListBean> masterVotingList) {
        this.masterVotingList = masterVotingList;
    }

    public static class MasterVotingListBean {
